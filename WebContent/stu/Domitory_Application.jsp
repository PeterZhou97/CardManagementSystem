<%@ page language="java" contentType="text/html; charset=gbk" import="dao.DormitoryDao,entity.Dormitory,java.util.*"
    pageEncoding="gbk"%>
<!DOCTYPE html>
  				...
  				<tbody>
  					<%
  						for(Dormitory dorm:DormitoryList){
  							...
  							out.println("<td><a href='../DormitoryServlet?opttype=application&method=post&DormID="+dorm.getId()+"'>申请住宿</a></td>");
  							out.println("</tr>");
  						}
  					%>
  				</tbody>
